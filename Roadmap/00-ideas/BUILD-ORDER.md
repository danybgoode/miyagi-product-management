...
- [Selección: make admin pins authoritative](../../01-discovery-and-shopping/seleccion-pins-authoritative/README.md) — 01 Discovery · 5/5 stories
...
- [Owned-shop operating channel — make a shop sellable without marketplace admission](../../07-agentic-and-federated-commerce/owned-shop-operating-channel/README.md) — 07 Agentic/Federated · 10/10 stories · risk: High · Wave 1
...
- [Seasonal Theme Engine](../../08-growth-and-promotions/seasonal-theme-engine/README.md) — 08 Growth · 9/9 stories
...
- [Golden Frijoles is the only flag surface — activate, retire the second lane, label the mirror](../../09-platform-infra/flag-provider-mandate/README.md) — 09 Platform-infra · 11/11 stories · risk: High · wave-2026-09-16
...
- [Hyper-performant runtime](../../09-platform-infra/hyper-performant-runtime/README.md) — 09 Platform-infra · 10/10 stories · risk: High
...
- [Interaction feedback + the admin surfaces that were lying](../../09-platform-infra/interaction-feedback-and-admin-repair/README.md) — 09 Platform-infra · 11/11 stories
...
- [Tenant lifecycle — give /admin real control over shops](../../09-platform-infra/tenant-lifecycle-admin/README.md) — 09 Platform-infra · 9/9 stories
...
- [Flag lane cleanup — drop the parked platform_flags + legacy mirror, retire dead env vars](seeds/flag-lane-cleanup.md) — Raw · Chore
...
---
_Epics: 157 · seeds in funnel: 8 · status drift: 2. Regenerate with `node scripts/build-order.mjs`._
