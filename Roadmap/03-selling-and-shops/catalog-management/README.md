...
- [x] All sprints merged to `main` + smoke-tested (gaps stated — S2/S4 money-path legs still owed as lower-priority follow-ups, see `RETROSPECTIVE.md`)
...
- [x] Kill-switches exist with stated polarity: `catalog.bulk_enabled` (S3, fail-closed OFF, flipped ON after Daniel's S3 smoke) and `seller.shell_on_sell_enabled` (S6.1, kill-switch — default true, created ENABLED in every env, confirmed live by Daniel 2026-07-11)
