...
|---|---|---|
| [backend-production-readiness](backend-production-readiness/) | Backend prod-readiness audit (staging · backups · recovery · monitoring · security · scaling) → hardening; opens with an audit spike that decides the staging platform | 📋 Scaffolded 2026-06-10 (audit-first; S0 spike is the gate) |
