...
| [feature-flags-killswitches](feature-flags-killswitches/) | Flagsmith as the platform's fail-open, admin-only, server-evaluated kill-switch layer (S1: `checkout.stripe_enabled` at the checkout-options proxy, flip-without-deploy) | 🚧 S1 merged 2026-06-06 (PR #34; Vercel env activation owed); future sprints deferred |
