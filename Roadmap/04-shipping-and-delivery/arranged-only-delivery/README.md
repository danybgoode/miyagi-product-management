...
| | S2.2 Close the service/rental card-payment hole — make arranged the canonical coordinated signal so service/rental can't be card-paid despite `coord` fulfillment (map them to arranged, or extend the 422 guard) + regression spec | HIGH |
