...
test('AGY_PINNED bumped to the verified 1.1.15 (guards the deliberate bump)', () => {
  // 1.1.13 → 1.1.15 (2026-08-19), verified by `agy-doctor --fix`: help contract
  // intact, both slugs still listed by `agy models`, primary model answered a
  // live probe. The fallback reported provider capacity trouble, which is now a
  // distinct verdict from an interface break — see UPSTREAM_UNAVAILABLE.
  assert.equal(AGY_PINNED, '1.1.15');
