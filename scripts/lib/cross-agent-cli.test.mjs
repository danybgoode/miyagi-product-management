...
test('AGY_PINNED bumped to the verified 1.1.17 (guards the deliberate bump)', () => {
  // 1.1.16 → 1.1.17 (2026-08-22), verified by `agy-doctor --fix`: help contract
  ...
  assert.equal(AGY_PINNED, '1.1.17');
